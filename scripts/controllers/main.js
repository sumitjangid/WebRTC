  ...
  */
  ...
  angular.module('PubNubAngularApp').controller('JoinCtrl', function($rootScope, $scope, $location, PubNub) {
    ...
    $scope.join = function() {
      ...
      $rootScope.secretKey = $scope.data["super"] ? 'sec-c-YWM5NDVhYTktOTA2ZC00OWZmLWI4MDgtNjBiZWNmNmEwMzA2' : null;
      $rootScope.authKey = $scope.data["super"] ? 'ChooseABetterSecret' : null;
      PubNub.init({
        subscribe_key: 'sub-c-6e34a816-7cc7-11e5-a643-02ee2ddab7fe',
        publish_key: 'pub-c-d8afc99f-342e-4c12-afc5-fb1e3bd208fb',
